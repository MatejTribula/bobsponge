...
public class Coastline : Minigame
{
    ...
    public override void Play()
    {
        ...
        Console.WriteLine("Turtle guided to safety! Well done! You've made the lagoon a safer place. Keep up the great work as you move on to the next level!");
        IsComplete = true;
    }
}